...
class CharacterChatBot():
    ...
    def train(self,
        ...
        model = PeftModel.from_pretrained(base_model, tokenizer, "final_ckpt")
    ...
    def load_data(self):
        ...
        naruto_transcript_df['line'] = naruto_transcript_df['line'].apply(self.remove_parenthesis)
        ...
        for idx in indexes_to_take:
            ...
            prompt += naruto_transcript_df.iloc[idx - 1]['line'] # someone speaks before naruto
            prompt += '\n'
            prompt += naruto_transcript_df.iloc[idx]['line'] # naruto response
